...
export const createRussianBankAccount = (questionaryData: QuestionaryData): RussianBankAccount => {
    const account = get(questionaryData, 'bank_account.russian_bank_account.account', '') || '';
    const bank_name = get(questionaryData, 'bank_account.russian_bank_account.bank_name', '') || '';
    const bank_bik = get(questionaryData, 'bank_account.russian_bank_account.bank_bik', '') || '';
    const bank_post_account =
